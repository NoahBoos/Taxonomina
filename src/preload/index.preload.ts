...
contextBridge.exposeInMainWorld("txnmAPI", {
    ...
    repositories: {
        ...
        entry: {
            ...
            create: (entry: I_Entry): Promise<[boolean, I_Entry | undefined]> => ipcRenderer.invoke("txnmAPI:repositories:entry:create", entry),
            update: (entry: I_Entry): Promise<[boolean, I_Entry | undefined]> => ipcRenderer.invoke("txnmAPI:repositories:entry:update", entry),
