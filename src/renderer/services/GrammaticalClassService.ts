...
export class GrammaticalClassService {
    ...
    public static async save(grammatical_class: I_GrammaticalClass): Promise<[boolean, I_GrammaticalClass | undefined]> {
        let [success, saved_grammatical_class] = grammatical_class.id == 0
        ...
        return [success, saved_grammatical_class];
    }
