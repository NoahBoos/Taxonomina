...
export class EntryService {
    ...
    public static async ReadAllByGlobalTranslation(rawEntry: I_Entry): Promise<I_Entry[]> {
        return await window.txnmAPI.repositories.entry.ReadAllByGlobalTranslation(rawEntry);
    }

    public static async ReadAllByLocalTranslation(rawDefinition: I_Definition): Promise<I_Entry[]> {
        return await window.txnmAPI.repositories.entry.ReadAllByLocalTranslation(rawDefinition);
    }

    public static async ReadOne(entryId: number): Promise<I_Entry> {
        return await window.txnmAPI.repositories.entry.ReadOne(entryId);
    }
    ...
    public static async BindToGrammaticalGenre(entry: I_Entry, genre: I_GrammaticalGenre) {
        return await window.txnmAPI.repositories.entry.BindToGrammaticalGenre(entry, genre);
    }

    public static async UnbindFromGrammaticalGenre(entry: I_Entry, genre: I_GrammaticalGenre) {
