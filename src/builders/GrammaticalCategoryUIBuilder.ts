...
export class GrammaticalCategoryUIBuilder {
    ...
    public static async RenderPageCounter() {
        ...
        pageCounter.textContent = String(GrammaticalCategoryUIBuilder.totalPages >= 1 ? GrammaticalCategoryUIBuilder.currentPage : 0) + "/" + String(GrammaticalCategoryUIBuilder.totalPages);
