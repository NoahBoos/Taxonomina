        ...
        txnmAPI: {
            ...
            repositories: {
                ...
                dictionary: {
                    ...
                    create: (dictionary: I_Dictionary) => Promise<[boolean, I_Dictionary | undefined, TaxonominaError<ErrorDomain>[]]>,
                    update: (dictionary: I_Dictionary) => Promise<[boolean, I_Dictionary | undefined, TaxonominaError<ErrorDomain>[]]>,
                    delete: (dictionary_id: number) => Promise<boolean>,
                },
                entry: {
                ...
                grammaticalGenre: {
                    ...
                    create: (grammatical_genre: I_GrammaticalGenre) => Promise<[boolean, I_GrammaticalGenre | undefined, TaxonominaError<ErrorDomain>[]]>,
                    update: (grammatical_genre: I_GrammaticalGenre) => Promise<[boolean, I_GrammaticalGenre | undefined, TaxonominaError<ErrorDomain>[]]>,
