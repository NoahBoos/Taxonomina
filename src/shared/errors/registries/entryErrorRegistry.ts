...
export const ENTRY_ERROR_REGISTRY = RegistryManager.create('entry', {
    ...
    E0302: { target: { type: 'form_field', field_name: 'lemma' }, severity: 'error', message: 'Le lemme ne peut pas être vide. Veuillez en saisir un.' },
    E0303: { target: { type: 'form_field', field_name: 'language_id' }, severity: 'error', message: 'Une entrée ne peut pas être créée sans être liée à une langue. Veuillez en sélectionner une.' }
});